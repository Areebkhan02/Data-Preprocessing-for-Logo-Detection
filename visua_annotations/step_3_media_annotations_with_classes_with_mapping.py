...
# Predefined logo-to-class mapping
logos_mapping = {
    "Ford_14305": 0,
    "Gaffel_67270": 1,
    "Ford_14306": 2,
    "Lotto_39406": 3,
    "Lotto_39407": 4,
    "Messe Dusseldorf_114666": 5,
    "Messe Dusseldorf_114665": 6,
    "Ford_447": 7,
    "Hyundai_14638": 8,
    "AOK_183490": 9,
    "AOK_183489": 10,
    "Gaffel_72638": 11,
    "Schwarzwaldmilch_204615": 12,
    "Hyundai_256": 13,
    "1&1_103699": 14,
    "Matthäi Gruppe_184405": 15,
    "Haake Beck_112395": 16,
    "MAN_44465": 17,
    "best medical_184404": 18,
    "Huelsta_189383": 19,
    "VGH Versicherungen_184497": 20,
    "Braun_26698": 21,
    "apotal.de_103830": 22,
    "Adesso_107028": 23,
    "Hep_194308": 24,
        ...
        for idx, item in enumerate(data):
            ...
            if logo_part2 in logo_ids:
                ...
                if video_name == medium:
                    ...
                    # Use the predefined class number from logos_mapping
                    class_id = logos_mapping.get(logo, -1)  # Use -1 or another default if not found

                    if class_id == -1:
                        print(f"Warning: Logo '{logo}' not found in logos_mapping dictionary.")
                        continue
